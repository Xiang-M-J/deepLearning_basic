...
from TIM_ import TIMNet
from config import Args
from utils import myLoader, accuracy_cal, plot_matrix, RAVDESS_LABELS
...
arg = Args()
data = np.load('preprocess/npy/RAVDESS.npy', allow_pickle=True).item()
x = data['x']
y = data['y']
...
trainer = pl.Trainer(accelerator="gpu", devices=1, callbacks=load_callbacks(), max_epochs=arg.epochs, logger=logger)
